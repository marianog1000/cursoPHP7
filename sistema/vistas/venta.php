              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Venta <button class="btn btn-success" onclick="mostrarForm(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body " style="height: 400px;" id="formularioregistros">
                      <form name="formulario" id="formulario" method="POST">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                              ...
                              <th></th>
                              <th></th>
                              <th><h4 id="total">S/.00</h4><input type="hidden" name="total_venta" id="total_venta"></th>
                            </tfoot>
                            <tbody>
                        ...
                        <div class="form-group col-lg-12 col-mg-12 col-sm-12 col-xs-12" id="guardar">
    ...
    <div class="modal-dialog" style="width: 65% !important;">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table id="tblarticulos" class="table table-striped table-condensed table-bordered table-hover">
            <thead>
              <th>Opciones</th>
              <th>Nombre</th>
              <th>Categoría</th>
